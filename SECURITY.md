...
If you find a security vulnerability in s_spatioloji, please report it through [GitHub's private vulnerability reporting](https://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.project_slug }}/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact gynecoloji@gmail.com for details.
